...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(`#${slideId} .carousel-indicators li`).click(e => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.tab = function () {
  for (let i = 0; i < this.length; i++) {
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).on("click", () => {
      (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).addClass("tab-item--active") // Add class to target
      ...
      .eq((0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).index()) // get active tab number of line
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.get = async (url, dataTypeAnswer = "json") => {};
